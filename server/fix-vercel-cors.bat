@echo off
echo Fixing CORS issues for specific Vercel domain...

echo Copying the Vercel-specific app.py file...
copy /Y src\app.py.vercel-fix src\app.py
...
echo - Frontend: https://alumni-client-c09kk4d6h-mhpens-projects.vercel.app
