...
echo.
echo Step 1: Building and pushing minimal Docker image...
call .\build-minimal.bat

echo.
echo Step 2: Building and pushing simple Docker image...
call .\build-simple.bat

echo.
echo Step 3: Building and pushing standalone Docker image...
call .\build-standalone.bat

echo.
echo Step 4: Building and pushing prebuilt Docker image...
call .\build-prebuilt.bat

echo.
echo Step 5: Building and pushing nginx Docker image...
